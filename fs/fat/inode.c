...
#endif
#ifdef CONFIG_SNSC_FS_FAT_BATCH_SYNC
	Opt_batch_dirsync, Opt_batch_sync_no, Opt_batch_sync_yes,
#endif
#ifdef CONFIG_SNSC_FS_FAT_RELAX_SYNC
	Opt_relax_sync,
#endif
...
static const match_table_t fat_tokens = {
	...
	{Opt_batch_sync_no, "batch_sync=0"},  /* 0 or no or false */
	{Opt_batch_sync_no, "batch_sync=no"},
	{Opt_batch_sync_no, "batch_sync=false"},
	{Opt_batch_sync_yes, "batch_sync=1"}, /* empty or 1 or yes or true */
	{Opt_batch_sync_yes, "batch_sync=yes"},
	{Opt_batch_sync_yes, "batch_sync=true"},
	{Opt_batch_sync_yes, "batch_sync"},
#endif
#ifdef CONFIG_SNSC_FS_FAT_RELAX_SYNC
	...
	*debug = 0;
	...
	while ((p = strsep(&options, ",")) != NULL) {
		...
		case Opt_batch_dirsync:
			opts->dirsync = 1;
		case Opt_batch_sync_yes:
			opts->batch_sync = 1;
			break;
		case Opt_batch_sync_no:
			opts->batch_sync = 0;
			break;
#endif
#ifdef CONFIG_SNSC_FS_FAT_RELAX_SYNC
