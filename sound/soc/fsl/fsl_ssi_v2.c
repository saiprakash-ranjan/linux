...
struct fsl_ssi_private {
	...
	/* IMX PCM FIQ not supported currently */
#if 0
	...
	struct snd_pcm_hw_params *hw_params, struct snd_soc_dai *cpu_dai)
{
	...
	unsigned int sample_size = snd_pcm_format_width(params_format(hw_params));
		...
		struct fsl_ssi_private *ssi_private, void __iomem *iomem)
{
	...
	if (ssi_private->use_dma && !ret && dmas[2] == IMX_DMATYPE_SSI_SP) {
