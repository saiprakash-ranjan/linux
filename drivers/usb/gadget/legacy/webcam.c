...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_yuv_400p = {
	...
	.bmCapabilities		= 0,
	.wWidth			= cpu_to_le16(640),
	.wHeight		= cpu_to_le16(400),
	.dwMinBitRate		= cpu_to_le32(245760000),
	.dwMaxBitRate		= cpu_to_le32(245760000),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(512000),
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_yuv_640x800 = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 5,
	...
	.dwMinBitRate		= cpu_to_le32(491520000),
	.dwMaxBitRate		= cpu_to_le32(491520000),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(1024000),
	.dwDefaultFrameInterval	= cpu_to_le32(166666),
	.bFrameIntervalType	= 1,
	.dwFrameInterval[0]	= cpu_to_le32(166666),
};
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_i420_360p = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 1,
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_i420_400p = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 2,
	...
	.wWidth			= cpu_to_le16(640),
	.wHeight		= cpu_to_le16(400),
	.dwMinBitRate		= cpu_to_le32(184320000),
	.dwMaxBitRate		= cpu_to_le32(184320000),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(384000),
	.dwDefaultFrameInterval	= cpu_to_le32(166666),
	.bFrameIntervalType	= 1,
	.dwFrameInterval[0]	= cpu_to_le32(166666),
};
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_i420_1080p = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 4,
	...
	.wWidth			= cpu_to_le16(1920),
	.wHeight		= cpu_to_le16(1080),
	.dwMinBitRate		= cpu_to_le32(1492992000),
	.dwMaxBitRate		= cpu_to_le32(1492992000),
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_i420_640x800 = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(1),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 5,
...
static const struct uvc_descriptor_header * const uvc_fs_streaming_cls[] = {
	...
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_400p,
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_720p,
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_1080p,
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_640x800,
...
static const struct uvc_descriptor_header * const uvc_ss_streaming_cls[] = {
	...
	(const struct uvc_descriptor_header *) &uvc_frame_i420_400p,
	(const struct uvc_descriptor_header *) &uvc_frame_i420_720p,
	(const struct uvc_descriptor_header *) &uvc_frame_i420_1080p,
	(const struct uvc_descriptor_header *) &uvc_frame_i420_640x800,
	(const struct uvc_descriptor_header *) &uvc_color_matching,
	NULL,
};
