...
struct sw_hci_hcd {
	...
	void __iomem *phy_csr; /* USB base address */
...
extern struct sw_hci_hcd * sunxi_prepare_sw_hci_hcd(struct platform_device * pdev, int *);
extern struct sw_hci_hcd *g_sw_ehci[3];
