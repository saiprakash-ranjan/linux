...
{
#ifdef CONFIG_SNSC_OPP_SUPPORT_ALT_OPP_TABLE
	return of_init_opp_table_name(dev, "operating-points");
}
EXPORT_SYMBOL_GPL(of_init_opp_table);

int of_init_opp_table_name(struct device *dev, const char *name)
{
#endif
...
#ifdef CONFIG_SNSC_OPP_SUPPORT_ALT_OPP_TABLE
EXPORT_SYMBOL_GPL(of_init_opp_table_name);
#else
EXPORT_SYMBOL_GPL(of_init_opp_table);
#endif
#endif
