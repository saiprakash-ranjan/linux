...
#ifdef CONFIG_OMAP2_DSS_DO_NOT_ENABLE_WOIHOUT_UNDERSTANDING_HACK_BRAVIA_HDMI
	/*
	 * This hackish fix is currently for BRAVIA-TV monitor on Pandaboard.
	 * Unlike LCD monitors, BRAVIA-TV takes around 100 ms for GPIO values
	 * to take effect.
	 * Do not enabled this unless you really need it, it slows down the
	 * booting by 150 ms !!!
	 */
	mdelay(150);
#endif
